<template>
  ...
  <div class="content">
    <p style="padding: 20px;">
      ...
      <strong>I. Informationen über uns als Verantwortliche</strong><br><br>
      Verantwortlicher Anbieter dieses Internetauftritts im datenschutzrechtlichen Sinne ist:<br><br>
      1. Majorettencorps Berlin e. V. • Les Amis - Die Freunde<br>
      Falkentaler Steig 36<br>
      13467 Berlin<br>
      Deutschland<br><br>
      Telefon: 0151 - 41 95 30 66<br>
      E-Mail: vorstand@majorettencorps.de<br><br>
      Datenschutzbeauftragte/r beim Anbieter ist:<br>
      Vorstand des 1. Majorettencorps Berlin e.V.<br><br>
      <strong>II. Rechte der Nutzer und Betroffenen</strong><br><br>
      ...
      <strong>III. Informationen zur Datenverarbeitung</strong><br><br>
      ...
      <strong>Serverdaten</strong><br><br>
      ...
      Mit Schließen Ihres Internet-Browsers werden diese Session-Cookies gelöscht.<br><br>
      ...
      Sollten Sie die Installation der Cookies verhindern oder einschränken, kann dies allerdings dazu führen, dass nicht sämtliche Funktionen unseres Internetauftritts vollumfänglich nutzbar sind.<br><br>
  ...
  >
    <div>
      <v-btn icon="mdi-instagram" href="https://www.instagram.com/1.majorettencorpsberlinlesamis/" class="mx-4"
             variant="text" color="black"></v-btn>
      <v-btn icon="mdi-facebook" href="https://www.tiktok.com/@majorettencorpsberlin?_t=8rRRET4QzUP&_r=1" class="mx-4"
             variant="text" color="black"></v-btn>
    </div>
